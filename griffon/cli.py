...
queries.add_command(queries_grp)
...
process.add_command(process_grp)
...
@click.group(
    cls=click.CommandCollection, sources=(entities, queries, process, manage, docs, plugin_commands)
)
